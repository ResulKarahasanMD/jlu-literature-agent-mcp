...
# "Bezmi Alem" / "BEZMI ALEM" (Taylor & Francis, RSC). JSTOR'daki "EKUAL" konsorsiyum adıdır,
# kurum kanıtı sayılmaz. Eşleşme zaten büyük/küçük harfe duyarsız (access_pattern).
DEFAULT_ACCESS_PATTERN = r"Bezm[-\s]?i[-\s]?alem"
